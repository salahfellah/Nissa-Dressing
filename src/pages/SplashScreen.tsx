...
export default function SplashScreen({ onNavigate }: { onNavigate: (view: AppView) => void }) {
  return (
    <div className="flex flex-col items-center justify-between min-h-screen p-8 fade-in max-w-md mx-auto">
      <div className="flex-1 flex flex-col justify-center w-full mt-12">
        ...
        <div className="mt-12 text-center">
          <p className="text-sm leading-relaxed mb-6 italic" style={{ color: COLORS.brunProfond }}>
            "Célébrer la féminité modeste à travers des créations élégantes et intemporelles."
          </p>
          <div className="flex justify-center items-center space-x-3 text-xs tracking-widest font-semibold" style={{ color: COLORS.orDore }}>
            <span>ÉLÉGANCE</span>
            <span>|</span>
            <span>MODESTIE</span>
            <span>|</span>
